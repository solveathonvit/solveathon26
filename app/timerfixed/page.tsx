...
export default function CountdownPage() {
    ...
    }, [countdownActive, inputHours, inputMinutes, inputSeconds]);
                ...
                <div className="container">
                    {!countdownActive && (
                        <div className="screen">
                            ...
                            <div className="time-selector fade-up delay-2">
                                <div className="time-input-group">
                                    <label className="time-input-label">Hours</label>
                                    <input type="number" className="time-input" value={inputHours} onChange={e => setInputHours(Number(e.target.value))} min="0" />
                                </div>
                                <div className="time-input-group">
                                    <label className="time-input-label">Minutes</label>
                                    <input type="number" className="time-input" value={inputMinutes} onChange={e => setInputMinutes(Number(e.target.value))} min="0" max="59" />
                                </div>
                                <div className="time-input-group">
                                    <label className="time-input-label">Seconds</label>
                                    <input type="number" className="time-input" value={inputSeconds} onChange={e => setInputSeconds(Number(e.target.value))} min="0" max="59" />
                                </div>
                            </div>
