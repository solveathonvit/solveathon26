...
export default function OrganizerCard({
  ...
  return (
    <div className="group relative timer-typography">
      {/* Glow effect */}
      ...
      <div className="relative bg-[#07080a]/90 border border-white/15 p-6 md:p-8 text-center backdrop-blur-sm hover:border-[#c8f059]/55 transition-all duration-300">
        {/* Avatar */}
        <div
        ...
        {phone ? (
          <a
            ...
            } text-white/65 hover:text-[#c8f059] transition break-all`}
          >
            <i className="fas fa-phone text-[#c8f059]" />
            {phone}
          </a>
        ) : (
          email && (
